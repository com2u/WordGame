    ...
    switch(object.Type) {
        case 'text':
            div.innerHTML = `
                ...
                //<p style="color: ${object.Color}; font-size: ${object.Size}px;">${object.Text}</p>
                <div style="color: ${object.Color}; font-size: ${object.Size}px;" class="formatted-text">${object.Text}</div>
